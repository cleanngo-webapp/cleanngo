...
@section('content')
{{-- Mobile-specific styles for completed bookings page responsiveness --}}
<style>
	/* Mobile responsive styles for completed bookings page */
	@media (max-width: 640px) {
		/* Ensure modals are mobile-friendly */
		#completed-payment-proof-modal .bg-white {
		...
		#completed-payment-proof-modal .grid-cols-1 {
			grid-template-columns: 1fr !important;
		}
		
		/* Ensure table doesn't cause horizontal overflow */
		#completed-bookings-table-container {
			overflow-x: auto;
...
<div class="max-w-7xl mx-auto px-2 sm:px-0">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4">
        <div>
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Completed Bookings</h1>
        ...
        <div class="flex items-center space-x-3">
            <a href="{{ route('admin.bookings') }}" 
               class="inline-flex items-center px-4 py-2 bg-gray-100 text-gray-700 rounded-lg text-sm font-medium hover:bg-gray-200 transition-colors">
                ...
                <span class="hidden sm:inline">Back to Active Bookings</span>
        ...
        <div class="p-4 sm:p-6 border-b border-gray-100">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center gap-4">
                ...
                <div class="flex flex-col sm:flex-row gap-2">
                    <select id="status-filter" class="px-3 sm:px-4 py-2 border border-gray-100 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">
    ...
    {{-- Completed Bookings Table - Responsive header --}}
    <div class="bg-white rounded-xl shadow-sm border border-gray-100">
        ...
        <div class="block sm:hidden">
            ...
            <div class="p-4 border-b border-gray-100 last:border-b-0 completed-booking-card" data-booking-id="{{ $b->id }}">
                <div class="space-y-3">
                    {{-- Booking Header --}}
                    <div class="flex items-center justify-between">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            <div class="text-xs text-gray-500 uppercase tracking-wider">Scheduled Date</div>
                    ...
                    {{-- Assigned Employee --}}
                    <div>
                        <div class="text-xs text-gray-500 uppercase tracking-wider mb-1">Assigned Employee</div>
                    ...
                    {{-- Payment Status and Completion Date --}}
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <div class="text-xs text-gray-500 uppercase tracking-wider mb-1">Payment Status</div>
                    ...
                    <div class="flex gap-2">
                        <button type="button" 
                                class="flex-1 inline-flex items-center justify-center px-3 py-1.5 border border-emerald-300 shadow-sm text-xs font-medium rounded-md text-emerald-600 hover:bg-emerald-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 transition-colors cursor-pointer" 
                        ...
                        @if($b->status === 'completed' && $b->payment_proof_id)
                            <button type="button" 
                                    class="flex-1 inline-flex items-center justify-center px-3 py-1.5 border border-green-300 shadow-sm text-xs font-medium rounded-md text-green-600 hover:bg-green-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors cursor-pointer" 
        ...
        <div id="completed-pagination-container" class="px-4 sm:px-6 py-4 border-t border-gray-100">
            {{ $bookings->links() }}
        </div>
    </div>
