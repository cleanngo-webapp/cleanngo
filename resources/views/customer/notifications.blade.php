...
@section('content')
<div class="max-w-4xl mx-auto mt-8 pt-6">
    <!-- Header Section -->
        ...
        <div class="flex justify-between items-center">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500">Stay updated with your booking and service information</p>
                </div>
            </div>
            @if($unreadCount > 0)
        ...
        @empty
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-12 text-center">
                ...
                <p class="text-sm text-gray-500 max-w-sm mx-auto">
                    You'll see notifications here when there are updates to your bookings, payments, or service assignments.
                </p>
            </div>
        @endforelse
    </div>
